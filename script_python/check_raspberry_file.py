...
def get_sent_mex(path):
    ...
    for item in mex:
        if item['type_mex'] == "S":
            set_element.add(item['message_id'])
...
def main():
    ...
    path = "./json_file/test_2019_12_09/test_19_12_09-21_20_55_analysis.json"
    sent_mex = get_sent_mex(path=path)

    path = "./json_file/test_2019_12_09/raspberry_19_12_09-21_20_55.json"
