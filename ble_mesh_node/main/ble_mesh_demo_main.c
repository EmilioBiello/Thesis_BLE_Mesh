...
static void esp_ble_mesh_model_cb(esp_ble_mesh_model_cb_event_t event,
    ...
    switch (event) {
        case ESP_BLE_MESH_MODEL_OPERATION_EVT: {
            ...
            printf("- element idx: \t %u\n", param->model_operation.model->element_idx);
            printf("- model idx: \t %u\n", param->model_operation.model->model_idx);
            printf("- addr: %u &&\t recv_dst: %u\n", param->model_operation.ctx->addr,
                   param->model_operation.ctx->recv_dst);
            printf("- send_ttl: %u && recv_ttl: %u\n", param->model_operation.ctx->send_ttl,
